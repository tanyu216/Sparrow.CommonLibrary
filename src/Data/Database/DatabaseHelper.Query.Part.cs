...
namespace Sparrow.CommonLibrary.Data.Database
{
    ...
    public partial class DatabaseHelper
    {
        ...
        public T ExecuteFirst<T>(ConditionExpressions expressions)
        {
        ...
        public T ExecuteFirst<T>(ConditionExpressions expressions, SqlOptions options)
        {
        ...
        /// <param name="expressions">获取数据的查询表达式</param>
        /// <param name="transaction"> </param>
        public T ExecuteFirst<T>(ConditionExpressions expressions, DbTransaction transaction)
        {
        ...
        /// <param name="transaction"> </param>
        /// <param name="options"> </param>
        public T ExecuteFirst<T>(ConditionExpressions expressions, DbTransaction transaction, SqlOptions options)
        {
            if (expressions == null) throw new ArgumentNullException("expressions");
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="expressions">获取数据的查询表达式</param>
        public IList<T> ExecuteList<T>(ConditionExpressions expressions)
        {
        ...
        /// <param name="expressions">获取数据的查询表达式</param>
        /// <param name="options"> </param>
        public IList<T> ExecuteList<T>(ConditionExpressions expressions, SqlOptions options)
        {
            if (expressions == null) throw new ArgumentNullException("expressions");
        ...
        /// <param name="expressions">获取数据的查询表达式</param>
        /// <param name="transaction"> </param>
        public IList<T> ExecuteList<T>(ConditionExpressions expressions, DbTransaction transaction)
        {
        ...
        /// <param name="transaction"> </param>
        /// <param name="options"> </param>
        public IList<T> ExecuteList<T>(ConditionExpressions expressions, DbTransaction transaction, SqlOptions options)
        {
            if (expressions == null) throw new ArgumentNullException("expressions");
