...
namespace Sparrow.CommonLibrary.Data.Database
{
    ...
    public partial class DatabaseHelper
    {
        ...
        /// <returns></returns>
        internal protected string BuildDqlSql<T>(ConditionExpressions expressions, ParameterCollection output, SqlOptions options, out IMapper<T> mapper)
        {
            ...
            return EntityToSql.StmBuilder.Select(mapper.MetaInfo, fields, expressions, output, options);
        }
